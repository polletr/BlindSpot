...
public class SonarPing : MonoBehaviour
{
    ...
    void HandlePoolsChanged(SonarConeVisualPool cone, SonarImpactPool _)
    {
        if (!autoResolvePoolsFromHub)
            return;
    ...
    void EnsureFlashlightVisual()
    {
        ...
        _flashlightVisual.BeginContinuous(transform, EffectiveFlashlightRange, EffectiveFlashlightAngle, obstacleMask, piercingUpgrade, rayCount, colorOverride: EffectiveFlashlightColor);
